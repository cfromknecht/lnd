...
type TrackPaymentResponse struct {
	...
	//*
	//List of all shard payments to this payment_hash [EXPERIMENTAL].
	Shards               []*PaymentStatus `protobuf:"bytes,4,rep,name=shards,proto3" json:"shards,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *TrackPaymentResponse) Reset()         { *m = TrackPaymentResponse{} }
func (m *TrackPaymentResponse) String() string { return proto.CompactTextString(m) }
...
func (m *TrackPaymentResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TrackPaymentResponse.Unmarshal(m, b)
}
func (m *TrackPaymentResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TrackPaymentResponse.Marshal(b, m, deterministic)
}
func (m *TrackPaymentResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TrackPaymentResponse.Merge(m, src)
}
func (m *TrackPaymentResponse) XXX_Size() int {
	return xxx_messageInfo_TrackPaymentResponse.Size(m)
}
func (m *TrackPaymentResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TrackPaymentResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TrackPaymentResponse proto.InternalMessageInfo

func (m *TrackPaymentResponse) GetState() PaymentState {
	if m != nil {
		return m.State
	}
...
func (m *TrackPaymentResponse) GetPreimage() []byte {
	if m != nil {
		return m.Preimage
	}
	return nil
...
func (m *TrackPaymentResponse) GetRoute() *lnrpc.Route {
	if m != nil {
		return m.Route
	}
	return nil
...
func (m *TrackPaymentResponse) GetShards() []*PaymentStatus {
	if m != nil {
		return m.Shards
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TrackPaymentResponse)(nil), "routerrpc.TrackPaymentResponse")
...
var fileDescriptor_7a0613f69d37b0a5 = []byte{
	...
	,
}
...
type Router_TrackPaymentClient interface {
	Recv() (*TrackPaymentResponse, error)
	grpc.ClientStream
}
...
func (x *routerTrackPaymentClient) Recv() (*TrackPaymentResponse, error) {
	m := new(TrackPaymentResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type Router_TrackPaymentServer interface {
	Send(*TrackPaymentResponse) error
	grpc.ServerStream
}
...
func (x *routerTrackPaymentServer) Send(m *TrackPaymentResponse) error {
	return x.ServerStream.SendMsg(m)
}
